...
logit 是odds的對數，可以看成log it(這裡的it代表的是odds)<br>

logistic function是一種函數，它創建一個概率值的映射，從顯示樣式 [0,1]到 [-∞,+∞]<br>

兩者為轉換關係，兩者之間的差異在於：logit主要在於顯示係數，logistic則為顯示勝算比率。
<br><br><br><hr>
